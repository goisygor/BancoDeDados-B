...
$stmt = $pdo->prepare('SELECT * FROM contatos ORDER BY id_completo OFFSET :offset LIMIT :limit');
	...
	<table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <a href="update.php?id=<?=$contact['id_completo']?>" class="edit"><i class="fas fa-pen fa-xs"></i></a>
                    <a href="delete.php?id=<?=$contact['id_completo']?>" class="trash"><i class="fas fa-trash fa-xs"></i></a>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
