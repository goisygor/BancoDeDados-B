...
$stmt = $pdo->prepare('SELECT * FROM entregas ORDER BY id OFFSET :offset LIMIT :limit');
...
<div class="content read">
	...
	<a href="create_entregas.php" class="create-contact">Realizar Entrega</a>
	<table>
        <thead>
            <tr>
                <td>#</td>
	...
	<div class="pagination">
		<?php if ($page > 1): ?>
		<a href="read_entregas.php?page=<?=$page-1?>"><i class="fas fa-angle-double-left fa-sm"></i></a>
		<?php endif; ?>
		<?php if ($page*$records_per_page < $num_contacts): ?>
		<a href="read_entregas.php?page=<?=$page+1?>"><i class="fas fa-angle-double-right fa-sm"></i></a>
		<?php endif; ?>
	</div>
</div>
